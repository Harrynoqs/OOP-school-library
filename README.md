...
- `git clone https://github.com/Harrynoqs/OOP-school-library.git` if your're using https or git 
- `git@github.com:Harrynoqs/OOP-school-library.git` if you prefer ssh and hit enter.
